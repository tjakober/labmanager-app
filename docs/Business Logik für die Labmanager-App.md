...
2. Rechte für die Labmanger App werden über die Fachgruppen zugeordnet. Fachgruppen-Mitglieder von FG ICT bekommen Admin-Rechte. FG Labmanager die Labmanager-Rechte. Alle anderen sind Mitglieder.
3. Alle können sich über über ihre im Webling erfasste Email-Adresse einloggen.
4. Erstmalig muss sich ein Mitglied über den Passwort-Vergessen Link registrieren. Er gibt sein Passwort dort bekannt und bekommt sein Login-Link über seine registriete Mailadresse zugestellt. Dazu muss sein Gerät mit seinem Mail-Client im Fablab Wifi Netz befinden.
5. Jedem Mitglied kann einen RFID Tag zugeordnet werden. Dann kann er sich in der Login-Maske auch mit dem Tag anmelden und muss nur noch sein Paswort eingeben.
...
Im Admin-Bereich der Labmanager-App kann konfiguriert werden, welche Adressen mit welchem Status im Webling verbleiben müssen.
Damit man möglichst viele Adressen im Webling online hat, wird beim Sych-Prozess berechent, für wieviele Monate zurück noch Adressen platz haben in der konfigurierbaren Maximum.
...
- **Belegung**
    Zeigt, wer derzeit an welcher Maschine welches Mitglied eingeloggt ist und wie lange schon. Wird alle 15 Sekunden akualisiert.
- **Einstellungen**
